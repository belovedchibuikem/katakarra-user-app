...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyB_JObaNRtYq3orajRFb0Gf2rR6sTC70Ns",
        authDomain: "smartcoophub-4b832.firebaseapp.com",
        projectId: "smartcoophub-4b832",
        storageBucket: "smartcoophub-4b832.firebasestorage.app",
        messagingSenderId: "720362904167",
        appId: "720362904167:web:021836d43616525b33d2c2"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyB_JObaNRtYq3orajRFb0Gf2rR6sTC70Ns",
        appId: "1:720362904167:android:021836d43616525b33d2c2",
        messagingSenderId: "720362904167",
        projectId: "smartcoophub-4b832",
      ),
    );
